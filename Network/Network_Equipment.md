...
# L4 Switch의 핵심적인 역할 - **Load Balancing**
* 기존에 운영중인 서버의 사용자들이 늘어나고, 그에 따라 서버의 규모를 증설할 필요성이 생김
* 여러 서버가 운영중일 때 사용자들의 요청(트래픽)을 골고루 분산
1. TCP의 3-Way handshake 과정에서 클라이언트와 서버 가운데 위치
