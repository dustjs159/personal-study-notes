...
# Layer 2 -L2 Switch : **MAC주소 기반 스위칭**
...
# Layer 4 -L4 Switch : **Load Balancing**
* L3 Switch의 상위 장비
...
* L4 스위치가 TCP/IP를 기반으로 로드밸런싱을 했다면 L7 스위치는 HTTP, FTP, SMTP, DNS등 상위 계층의 프로>토콜을 기반으로 로드밸런싱을 함
* 서비스 단위로 트래픽을 분산시킴
* 7계층(응용계층)에서 사용
